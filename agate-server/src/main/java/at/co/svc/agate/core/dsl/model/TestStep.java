...
public class TestStep {
    ...
    public void setDownload(List<DownloadConfig> download) { this.download = download; }
    
    // --- PROŠIRENJE: Polje za Upload listu konfiguracija ---
    private List<UploadConfig> upload = new ArrayList<>();

    public List<UploadConfig> getUpload() { return upload; }
    public void setUpload(List<UploadConfig> upload) { this.upload = upload; }
    
 // --- PDF Engine specifična polja ---
    ...
    public void setPdfAssertions(List<PdfAssertion> pdfAssertions) { this.pdfAssertions = pdfAssertions; }
    ...
    private String url;
    private String method; // Novo polje za HTTP metodu (GET, POST, itd.)
    private String body;
    ...
    // --- Getters and Setters for Hierarchy ---
    public String getId() { return id; }
    public void setId(String id) { this.id = id; }

    public List<TestStep> getSubSteps() { return subSteps; }
    public void setSubSteps(List<TestStep> subSteps) { this.subSteps = subSteps; }
